        ...
        <div class="mt-4">
            <div class="p-6 bg-white rounded-md shadow-md">
                ...
                <turbo-frame id="frame_update_password" @turboReload>
                    <form id="update_password" action="{{ route('accounts.passwords.update') }}"
                        method="POST" class="grid grid-cols-1 gap-6 mt-4">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mt-4 max-w-md">
                            <x-label for="current_password" class="text-gray-700">
                                ...
                                <x-input id="current_password" class="mt-2" type="password"
                        ...
                        <div class="mt-4 max-w-md">
                            <x-label for="new_password" class="text-gray-700">
                                ...
                                <x-input id="password" class="mt-2" type="password"
                        ...
                        <div class="mt-4 max-w-md">
                            <x-label for="new_password_confirmation" class="text-gray-700">
                                ...
                                <x-input id="new_password_confirmation" class="mt-2"
